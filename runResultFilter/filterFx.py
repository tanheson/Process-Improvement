...
try:
    ...
    logging.info("All desired folders and files are copied")

    # Log the completion time
    current_time = time.strftime("%H:%M:%S %Z, %Y-%m-%d", time.localtime())
    logging.info(f"Copy completed at {current_time} (e.g., 18:48 +08, 2025-08-06)")

except PermissionError:
    logging.error(f"Error: Permission denied while accessing '{source_folder}' or '{destination_folder}'. Ensure you have appropriate rights.")
